...
@NamedStoredProcedureQuery(name = "cm_dashboard_disease_trand", procedureName = "cm_dashboard_disease_trand", parameters = {
		...
		//FOR DM DASHBOARD
				...
				@NamedStoredProcedureQuery(name = "dm_dashboard_genderwise_patientno", procedureName = "dm_dashboard_genderwise_patientno", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_areawise_patientno", procedureName = "dm_dashboard_areawise_patientno", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_agewise_healthcheckup", procedureName = "dm_dashboard_agewise_healthcheckup", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_genderwise_diseasenm", procedureName = "dm_dashboard_genderwise_diseasenm", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_riskwise_patientno", procedureName = "dm_dashboard_riskwise_patientno", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_phcwise_patientno", procedureName = "dm_dashboard_phcwise_patientno", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				@NamedStoredProcedureQuery(name = "dm_dashboard_areawise_highrisk_dm", procedureName = "dm_dashboard_areawise_highrisk_dm", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				
				
				@NamedStoredProcedureQuery(name = "dm_dashboard_checkup_status", procedureName = "dm_dashboard_checkup_status", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				
				@NamedStoredProcedureQuery(name = "dm_dashboard_areawise_highrisk", procedureName = "dm_dashboard_areawise_highrisk", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),

		@NamedStoredProcedureQuery(name = "dm_dashboard_diseasewise_total", procedureName = "dm_dashboard_diseasewise_total", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),


		@NamedStoredProcedureQuery(name = "dm_dashboard_disease_trand", procedureName = "dm_dashboard_disease_trand", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
				...
				@NamedStoredProcedureQuery(name = "dm_dashboard_count_test_details", procedureName = "dm_dashboard_count_test_details", parameters = {
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "district", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "date", type = String.class),
						@StoredProcedureParameter(mode = ParameterMode.IN, name = "type", type = String.class) }),
