...
public class RestCmDao {
	...
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> cmDashboardGenderWisePatientno(String stateId,
			String date, String type) {
		logger.info("Method : viewdmDashboardCount starts");
		System.out.println("9999999999999999999999999999data"+stateId);
		...
		try {
			List<Object[]> x = em.createNamedStoredProcedureQuery("cm_dashboard_genderwise_patientno")
					.setParameter("stateId", stateId).setParameter("date", date).setParameter("type", type)
					.getResultList();
			for (Object[] m : x) {
				String date1 = null;

				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(m[0], m[1], null, null, null, null,
						null, m[2]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> cmDashboardAreaWisePatientno(String stateId,
			String date, String type) {
		logger.info("Method : viewdmDashboardCount starts");
		...
		try {
			...
			for (Object[] m : x) {
				...
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, null, m[0], null, null, null,
						null, m[1]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> cmDashboardAgeWisePatientno(String stateId,
			String date, String type) {
		...
		try {
			...
			for (Object[] m : x) {
				...
				// date1 = DateFormatter.returnStringDateNew(m[0].toString());
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, null, null, m[0], null, null,
						null, m[1]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> cmDashboardDiseaseMaleFemaleWisePatientno(
			String stateId, String date, String type) {
		logger.info("Method : cmDashboardAgeWisePatientno starts");
		...
		try {
			...
			for (Object[] m : x) {
				...
				// date1 = DateFormatter.returnStringDateNew(m[0].toString());
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, m[0], null, null, m[1], null,
						null, m[2]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<CMDashboardGraphicalModel>> cmDashboardRiskWisePatientno(String stateId,
			String date, String type) {
		...
		try {
			...
			for (Object[] m : x) {
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, null, null, null, null, null,
						m[0], m[1]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<CMDashboardGraphicalModel>> cmDashboardPhcWisePatientno(String stateId,
			String date, String type) {
		logger.info("Method : cmDashboardTestWisePatientno starts");
		...
		try {
			...
			for (Object[] m : x) {
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, null, null, null, null, m[0],
						m[1], m[2]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<CMDashboardGraphicalModel>> cmDashboardDieaseWisePatientno(String stateId,
			String date, String type) {
		...
		try {
			...
			for (Object[] m : x) {
				CMDashboardGraphicalModel reqemp = new CMDashboardGraphicalModel(null, null, null, null, m[0], null,
						null, m[1]);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<CMDashboardGraphicalModel>> cmDashboardpercentageDieaseWisePatientno(
			String stateId, String date, String type) {
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> totalHealthCheckup(String stateId, String date,
			String type) {
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> getHighRiskLocationWise(String stateId,
			String date, String type) {
		logger.info("Method : totalHealthCheckup starts");
	...
	@SuppressWarnings("unchecked")
	public JsonResponse<List<CMDashboardGraphicalModel>> cmDashboardDieaseWisePatientnoDao(String state, String date,
			String type) {
		logger.info("Method : cmDashboardDieaseWisePatientno starts");
		...
		try {
			List<Object[]> x = em.createNamedStoredProcedureQuery("cm_dashboard_diseasewise_total")
					.setParameter("stateId", state).setParameter("date", date).setParameter("type", type)
					.getResultList();
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<CMDashboardGraphicalModel>>> cmDashboardTreandingDisease(String stateId,
			String date, String type) {
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<CMDashboardGraphicalModel>> countTestDetailsDao(String stateId, String date,
			String type) {
		...
		try {
			...
			for (Object[] m : x) {
				 ...
				 * date1 = DateFormatter.returnStringDateNew(m[0].toString());
				 */
				CMDashboardGraphicalModel countDetails = new CMDashboardGraphicalModel(m[0], m[1], m[2], m[3], m[4],
						m[5], m[6], m[7], null);
  ...
  System.out.println("dmDashboardGetIdd========="+cmDashboardGetIdd);
