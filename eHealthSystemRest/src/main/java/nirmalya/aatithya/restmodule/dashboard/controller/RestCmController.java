...
public class RestCmController {
	...
	Logger logger = LoggerFactory.getLogger(RestCmController.class);
		...
		@GetMapping(value = "genderWise-patientnocm")
		...
		@GetMapping(value = "areWise-patientnocm")
		...
		@GetMapping(value = "ageWise-patientnocm")
		...
		@GetMapping(value = "diseaseWise-patientnocm")
		...
		@GetMapping(value = "riskWise-patientnocm")
		...
		@GetMapping(value = "phcWise-patientnocm")
	...
	/*	@GetMapping(value = "dieaseWise-patientno")
		...
		@GetMapping(value = "percentageDieaseWise-patientnocm")
		...
		//Total Health Checkup Status
				...
				@GetMapping(value = "rest-totalHealthCheckupcm")
		...
		//High Risk Data Location Wise
						...
						@GetMapping(value = "rest-getHighRiskLocationWisecm")
		...
		// Rest Disese wise total patient no
				@GetMapping(value = "dieaseWise-patientnocm")
		...
		@GetMapping(value = "treanding-diseasecm")
		...
		//count test details
				@GetMapping(value = "rest-countTestDetailscm")
				...
				@RequestMapping(value = "cmDashboardGetIdds", method = { RequestMethod.GET })
