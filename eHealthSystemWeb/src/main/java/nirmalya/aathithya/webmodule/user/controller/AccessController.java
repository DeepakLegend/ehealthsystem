...
public class AccessController {
	...
	@GetMapping("dmdashboard-view-count-acess")
	...
	@GetMapping("dmdashboard-view-regd-acess")
	...
	@GetMapping("dmdashboard-view-ageWiseTotalTest-acess")
	...
	@GetMapping(value = { "/dmdashboard-view-areaWiseTotalTest-acess" })
	...
	@GetMapping(value = { "/dmdashboard-view-diseaseWiseTotalAbnormal-acess" })
	...
	@GetMapping(value = { "/dmdashboard-view-diseaseWiseTotalHighRisk-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-male-female-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-normal-abNormal-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-disease-area-wise-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-area-wise-normal-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-area-wise-highrisk-acess" })
	...
	@GetMapping(value = { "/dmdashboard-health-check-up-gender-wise-disease-details-acess" })
	...
	public @ResponseBody JsonResponse<Object> addUserRegistration(HttpSession session,
		...
		// QR CODE
			...
			String msg = "Welcome to eHealthSystem. You are registered successfully! Your UserId is "+regdModel.getPatientId()+" or "+regdModel.getMob()+" and password is User@123 ";
